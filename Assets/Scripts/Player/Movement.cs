...
public class Movement : MonoBehaviour
{
    ...
    [Header("Sound Effects")]  // ← ADD THIS LINE
[SerializeField] private AudioClip jumpSound;  // ← ADD THIS LINE
[SerializeField] private AudioClip wallJumpSound;  // ← ADD THIS LINE
[SerializeField] private AudioClip landSound;  // ← ADD THIS LINE
private AudioSource audioSource;  // ← ADD THIS LINE
    ...
    private void Jump(Vector2 dir, bool wall) {
        ...
        particle.Play();
         ...
         // Play jump sound - different sounds for normal vs wall jump
        if (wall && wallJumpSound != null) {
            audioSource.PlayOneShot(wallJumpSound);
        } else if (!wall && jumpSound != null) {
